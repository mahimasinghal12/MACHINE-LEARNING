...
def main():
   ...
   <center><p style="font-size:30px;color:white;margin-top:10px;">NAME: MAHIMA SINGHAL</p></center>
   <center><p style="font-size:25px;color:white;margin-top:0px;">|| PIET18CS084 || Sec: B || Roll No 27 ||</p></center>
   </div>
   </div>
   </div>
   """
    ...
    if st.button("About"):
      st.subheader("Developed by MAHIMA SINGHAL")
